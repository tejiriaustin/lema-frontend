...
export function NewPostCard({ onClick }: NewPostCardProps) {
    return (
        <button
            onClick={onClick}
            className="button-block sqs-block-button-element w-[310px] h-[340px] flex flex-col items-center justify-center rounded-lg border-[1px] border-dashed border-[#D5D7DA] text-[#717680] hover:bg-gray-100"
        >
